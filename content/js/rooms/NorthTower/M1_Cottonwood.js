//North Tower M1 - Cottonwood Room (A & B) 

function NT_M1_CottonwoodAB(prevState){
	tooltip.hide();
		tooltipshape.hide();
	  ...
	  FloorObj.src = 'content/js/rooms/NorthTower/Images/NT_M1_CottonwoodAB/NT_M1_CottonwoodAB_Floor.png';
	  ...
	  //A
      var AObj = new Image();
	  AObj.src = 'content/js/rooms/NorthTower/Images/NT_M1_CottonwoodAB/NT_M1_CottonwoodAB_A.png';
	  ...
	  AObj.onload = function() {
		...
		this.transitionTo({
			...
			//update table info
			roomType.setText("Cottonwood A");
			roomSize.setText("611 sq ft");
			roomReception.setText("63");
			roomDimension.setText("24'5\" x 25'5\"");
	  ...
	  //B
      var BObj = new Image();
	  BObj.src = 'content/js/rooms/NorthTower/Images/NT_M1_CottonwoodAB/NT_M1_CottonwoodAB_B.png';
	  ...
	  BObj.onload = function() {
		...
		this.transitionTo({
			...
			//update table info
			roomType.setText("Cottonwood B");
			roomSize.setText("632 sq ft");
			roomReception.setText("68");
			roomDimension.setText("24'5\" x 25'3\"");
			roomCeilingHeight.setText("11'");
			roomTheater.setText("72");
			tableLayer.draw();
		});
